...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous">
    ...
    <div class="col-md-6 offset-md-3 align-self-center"> 
      ...
      <form method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="inputNorm" value="<?= $data['norm'] ?>" name="norm" placeholder="Masukan No.RM Pasien">
        </div>
        <div class="mb-3">
          <label for="inputNamapas" class="form-label">Nama Pasien</label>
          <input type="text" class="form-control" id="inputNamapas" value="<?= $data['namapas'] ?>" name="namapas" placeholder="Masukan Nama Pasien">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="inputRuang" value="<?= $data['ruang'] ?>" name="ruang" placeholder="Masukan Ruangan Pasien">
        </div>
        <div class="mb-3">
          <label for="inputTelepon" class="form-label">Telepon</label>
          <input type="text" class="form-control" id="inputTelepon" value="<?= $data['telepon'] ?>" name="telepon" placeholder="Masukan No. Telepon Pasien">
        </div>
  ...
  <?php
    ...
    if(isset($_POST['daftar'])){
      ...
      // Membuat Query
      $query = "UPDATE tb_siswa SET norm = '$norm', namapas = '$namapas', alamat = '$alamat', diagnosa = '$diagnosa', ruang = '$ruang', telepon = '$telepon' WHERE id = '$id'";
